...
$script_dir/../lib/update_cron.sh "0 * * * * "$script_dir/"monitor_node_confirmed_status.sh" $(hostname)
$script_dir/../lib/update_cron.sh "0 0 * * * "$script_dir/../lib/"monitor_logs_unattended_upgrades.sh"
$script_dir/../lib/update_cron.sh "30 3 1 * * "$script_dir/../lib/"clean_script_logs_older_n_days.sh" 90
